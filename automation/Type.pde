class Type extends Action {
  ...
  Type(String n, Robot r) {
    super(n,r); 
    this.r = r;
    this.name = n; 
  }
  
  private void doType(int ke) {
    println(ke);
    this.r.keyPress(ke); 
    this.r.keyRelease(ke); 
  }
  
  private void doType(int k1, int k2) {
    this.r.keyPress(k1);
    this.r.keyPress(k2); 
    this.r.keyRelease(k2);
    this.r.keyRelease(k1); 
  }
  ...
  // Found on http://stackoverflow.com/questions/1248510/convert-string-to-keyevents
